...
void Game::draw(){
    ...
    drawText(-9, 1, "Game 1", (selectedOption == 0));
    drawText(-9, -2, "Game 2", (selectedOption == 1));
...
void Game::loadTextures()
{
    ...
    // Load the image.
    image[0] = getBMP("..//Images//background3.bmp");
...
void Game::drawText(int x, int y, const char* text, bool selected) {
    glPushMatrix();
    glLineWidth(3.5);
